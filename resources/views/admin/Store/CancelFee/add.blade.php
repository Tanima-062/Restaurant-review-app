...
<div class="content pb-3 item-list-pc">
    ...
    <div class="d-flex col-md-9 justify-content-between">
        <h2 class="content-heading">{{ $store->name }} キャンセル料追加</h2>
    </div>
    <!-- Floating Labels -->
    <form method="post" action="{{ route('admin.store.cancelFee.add') }}">
        @csrf
            ...
            <div class="block-content" style="padding-bottom: 20px;">
                ...
                <div>
                        ...
                        <div class="form-material col-6 col-md-4 pl-0">
                            ...
                            <select class="form-control" name="app_cd">
                                @foreach($storeCancelFeeConst['app_cd'] as $key => $value)
                                    <option value="{{ $key }}" {{ $key == old('app_cd') ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row" id="date">
                        <div class="col-3">
                            <input type="text" class="form-control" id="apply_term_from" name="apply_term_from" value="{{old('apply_term_from')}}" autocomplete="off" required>
                        </div>
                        <span style="margin-top:5px">～</span>
                        <div class="col-3">
                            <input type="text" class="form-control" id="apply_term_to" name="apply_term_to" value="{{old('apply_term_to')}}" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-material col-6 col-md-4 pl-0">
                            ...
                            <select class="form-control" name="visit" id="visit">
                                @foreach($storeCancelFeeConst['visit'] as $key => $value)
                                    <option value="{{ $key }}" {{ $key == old('visit') }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="form-material col-6 col-md-4 pl-0">
                                ...
                                <select class="form-control" name="cancel_limit_unit" id="cancel_limit_unit">
                                    @foreach($storeCancelFeeConst['cancel_limit_unit'] as $key => $value)
                                        <option value="{{ $key }}" {{ $key == old('cancel_limit_unit') ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="visit-delete">
                        ...
                        <div class="form-group row" id="cancel_limit">
                            <div class="col-3">
                                <input type="text" class="form-control"  id="cancel_limit" name="cancel_limit" value="{{old('cancel_limit')}}">
                            </div>
                            ...
                            <div class="form-material col-6 col-md-4 pl-0">
                                ...
                                <select class="form-control" name="cancel_fee_unit" id="cancel_fee_unit">
                                    @foreach($storeCancelFeeConst['cancel_fee_unit'] as $key => $value)
                                        <option value="{{ $key }}" {{ $key == old('cancel_fee_unit') ? 'selected' : '' }}>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group row" id="cancel_fee">
                        <div class="col-3">
                            <input type="text" class="form-control"  id="cancel_fee_input" name="cancel_fee" value="{{old('cancel_fee')}}" required>
                        </div>
                        ...
                        <div class="col-3" id="fraction_unit">
                            ...
                            <select class="form-control" id="fraction_unit" name="fraction_unit">
                                @foreach($storeCancelFeeConst['fraction_unit'] as $key => $value)
                                    <option value="{{ $key }}" {{ $key == old('fraction_unit') ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-material col-6 col-md-4 pl-0">
                            ...
                            <select class="form-control" name="fraction_round">
                                @foreach($storeCancelFeeConst['fraction_round'] as $key => $value)
                                    <option value="{{ $key }}" {{ $key == old('fraction_round') ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group row" id="cancel_fee_max">
                        <div class="col-3">
                            <input type="text" class="form-control"  id="cancel_fee_max" name="cancel_fee_max" value="{{old('cancel_fee_max')}}">
                        </div>
                    ...
                    <div class="form-group row" id="cancel_fee_min">
                        <div class="col-3">
                            <input type="text" class="form-control"  id="cancel_fee_min" name="cancel_fee_min" value="{{old('cancel_fee_min')}}">
                        </div>
                        <span style="margin-top:5px">円</span>
                    </div>
                    <div class="form-group">
        ...
        <div class="block col-md-9">
            <div class="block-content" style="padding-bottom: 20px;">
                ...
                <div>
                    ...
                    <div class="form-group row" id="date">
                        <div class="col-5">
                            <input type="text" class="form-control" style="text-align:left;padding-left:4px;padding-right:4px;" id="apply_term_from_sp" name="apply_term_from" value="{{old('apply_term_from')}}" autocomplete="off" required>
                        </div>
                        <span style="margin-top:5px">～</span>
                        <div class="col-5">
                            <input type="text" class="form-control" style="text-align:left;padding-left:4px;padding-right:4px;" id="apply_term_to_sp" name="apply_term_to" value="{{old('apply_term_to')}}" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-material col-6 col-md-6 pl-0">
                    ...
                    <div class="form-group row">
                        ...
                        <label for="fraction_round" class="col-2 col-md-2 col-form-label pl-0" style="font-weight:normal;">単位</label>
                            ...
                            <!-- <span class="col-2" style="margin-top:35px">単位</span> -->
                    <label for="fraction_round">端数処理(round)<span class="badge bg-danger ml-2 text-white">必須</span></label>
                    <div class="form-group row">
