                        ...
                        <ul class="nav-users push">
                            <li>
                                <a href="be_pages_generic_profile.html">
                                    <img class="img-avatar" src="{{ asset('vendor/codebase/assets/media/avatars/avatar7.jpg') }}" alt="">
                            ...
                            <li>
                                <a href="be_pages_generic_profile.html">
                                    <img class="img-avatar" src="{{ asset('vendor/codebase/assets/media/avatars/avatar11.jpg') }}" alt="">
                            ...
                            <li>
                                <a href="be_pages_generic_profile.html">
                                    <img class="img-avatar" src="{{ asset('vendor/codebase/assets/media/avatars/avatar4.jpg') }}" alt="">
